...
public class ExpandableListAdapterFilterSort extends BaseExpandableListAdapter {
	...
	public ExpandableListAdapterFilterSort(Context context, List<String> listDataHeader, List<String> listDataSubHeader,
