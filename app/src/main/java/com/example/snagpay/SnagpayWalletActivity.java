...
public class SnagpayWalletActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.rltvRequestStatement).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SnagpayWalletActivity.this, StatementActivity.class));
            }
        });
        ...
        listAdapterPayment = new ExpandableListAdapterPaymentRecent(SnagpayWalletActivity.this, paymentModelArrayList);
